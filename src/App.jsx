...
const STUDIO_CONFIG = {
  name: "BARKLEY",
  subtitle: "YOGA",
  tagline: "Yoga is for EVERYBODY.",
  logoMark: "BY",
  description: "Infrared-heated and non-heated yoga in Bellingham. Hot vinyasa, 84-posture hatha, yin, sculpt, qigong. State-of-the-art infrared. Every body welcome.",
  heroLine1: "EVERY",
  heroLine2: "BODY",
  address: { street: "3130 Howe Pl, Unit 102", city: "Bellingham", state: "WA", zip: "98226" },
  phone: "(360) 720-5364",
  email: "info@barkleyyoga.com",
  neighborhood: "Barkley, Bellingham",
  website: "https://www.barkleyyoga.com",
  social: { instagram: "@barkleyyoga" },
  locations: [{ name: "Barkley Studio", type: "yoga" }],
  theme: {
    accent:     { h: 25,  s: 52, l: 46 },
    accentAlt:  { h: 170, s: 30, l: 42 },
    warning:    { h: 45,  s: 60, l: 50 },
    primary:    { h: 20,  s: 18, l: 10 },
    surface:    { h: 25,  s: 10, l: 97 },
    surfaceDim: { h: 22,  s: 8,  l: 93 },
  },
  features: {
    ...
    multiLocation: false, infraredHeat: true, qigong: true, sculpt: true,
  },
  classCapacity: 25,
...
const GRADIENTS = {
  ...
  schedule: `linear-gradient(135deg, hsl(20,22%,22%) 0%, hsl(25,52%,18%) 100%)`,
  practice: `linear-gradient(135deg, hsl(25,40%,26%) 0%, hsl(20,18%,14%) 100%)`,
  community: `linear-gradient(135deg, hsl(45,60%,28%) 0%, hsl(20,18%,14%) 100%)`,
  teachers: `linear-gradient(135deg, hsl(25,52%,28%) 0%, hsl(170,20%,18%) 100%)`,
  events: `linear-gradient(135deg, hsl(170,30%,24%) 0%, hsl(25,25%,16%) 100%)`,
  membership: `linear-gradient(135deg, hsl(25,52%,22%) 0%, hsl(45,30%,18%) 100%)`,
};
...
const T = {
  ...
  text: "#1e1610", textMuted: "#786048", textFaint: "#a88868",
  border: "#e0d0c0", borderLight: "#f0e8dc",
};
...
const TEACHERS = [
  { id: "t1", firstName: "Kristel", lastName: "Chilton", role: "Owner & Lead Teacher", certs: ["20+ Years Practice", "Studio Owner"], specialties: ["Vinyasa", "Heated Hatha", "Studio Vision"], yearsTeaching: 10, bio: "Yoga has been the cornerstone in helping Kristel manage through stress, anxiety, and physical injuries including knee, shoulder, and neck pain. She relocated to Bellingham in 2020 and feels blessed to share the yoga journey and evolve Barkley Yoga with the community.", photo: "" },
  { id: "t2", firstName: "Jen", lastName: "M.", role: "Teacher & Ayurvedic Nutritionist", certs: ["RYT-200", "Certified Ayurvedic Nutritionist"], specialties: ["Vinyasa", "Pranayama", "Ayurveda"], yearsTeaching: 14, bio: "Jen realized her passion for yoga in 2009 at Hot Yoga Inc. in Bellevue. She has taught across Washington State from Seattle to Walla Walla. With deep reverence for Ayurveda, she emphasizes pranayama, groundedness, intention holding, and reconnecting body, mind, and energy centers.", photo: "" },
  { id: "t3", firstName: "Lisa", lastName: "R.", role: "Teacher", certs: ["RYT-500", "Modo Yoga Brazil"], specialties: ["Hot Yoga", "Vinyasa", "Healing Practice"], yearsTeaching: 12, bio: "Lisa discovered yoga after a traumatic car accident in 2011. She completed Modo Yoga 500-hour training in Brazil, learning to guide the practice that wholly supported her physical and emotional recovery. Yoga became her path of healing.", photo: "" },
  { id: "t4", firstName: "David", lastName: "K.", role: "Qigong Teacher", certs: ["Qigong Certified", "Daoist Longevity Practitioner"], specialties: ["Qigong", "Neigong", "Meditation"], yearsTeaching: 15, bio: "David teaches qigong as moving meditation with seasonal forms, Tao Yin meridian stretches, and seated guided meditation. Rooted in Daoist longevity applications, his practice incorporates gentle and dynamic movements as well as meditative alchemy.", photo: "" },
  { id: "t5", firstName: "Sarah", lastName: "P.", role: "Teacher", certs: ["RYT-200"], specialties: ["Slow Flow", "Yin", "Gentle"], yearsTeaching: 5, bio: "Sarah teaches the quieter side of Barkley. Her slow flow classes turn down the heat for a meditative practice that cultivates peace and calm. Her yin classes open the garage doors and let Bellingham air in while tension releases.", photo: "" },
];

const TODAYS_FOCUS = {
  id: "focus-today", date: today, name: "Hot Vinyasa", type: "HOT_VINYASA", style: "Hot Vinyasa", temp: "Infrared Heat", duration: 60,
  description: "Dynamic breath-to-movement flow in state-of-the-art infrared heat. Build strength, improve flexibility, and detoxify. The heat allows deeper stretches while protecting joints.",
  intention: "Come as you are. Leave as more of yourself.",
  teacherTip: "Infrared heated studio. Manduka mat and Yogitoes towel rental $5 each. Max 25 students. HVAC and air purifier. Bring water.",
};

const PAST_PRACTICES = [
  { id: "p-y1", date: offsetDate(-1), name: "Heated Hatha (84 Postures)", type: "HATHA", style: "Heated Hatha", temp: "Infrared Heat", duration: 90, description: "Derived from Patanjali original 84 postures. Statically held postures focusing on alignment and strength. Stimulates internal organs, glands, and nerves. Promotes detoxification. Challenging for all levels.", intention: "84 postures. Ancient wisdom. Modern heat. Your body." },
  { id: "p-y2", date: offsetDate(-2), name: "Yin (Non-Heated)", type: "YIN", style: "Yin", temp: "Non-heated", duration: 60, description: "Practiced on the floor with gravity and time. Opens joints, muscles, and deep connective tissues. The garage doors open and fresh Pacific Northwest air fills the studio. Leave feeling lighter and brighter.", intention: "Let gravity do the work. Let time do the rest." },
  { id: "p-y3", date: offsetDate(-3), name: "Qigong", type: "QIGONG", style: "Qigong", temp: "Non-heated", duration: 60, description: "Moving meditation. Warmups, seasonal form practice, Tao Yin meridian stretches, and seated guided meditation. Daoist longevity practices incorporating gentle and dynamic movements.", intention: "Move like water. Stand like a mountain. Breathe like the wind." },
];

const UPCOMING_PRACTICE = { id: "p-tmrw", date: offsetDate(1), name: "Sculpt", type: "SCULPT", style: "Sculpt", temp: "Heated", duration: 60, description: "Grab free weights and head to your mat. Power yoga sequencing with strength training. Build lean muscle, increase bone density, create a full-body workout. Energetic and invigorating.", intention: "Strength is a practice. Build it daily." };

const CLASSES_TODAY = [
  { id: "cl1", time: "07:00", type: "Hot Vinyasa", coach: "Kristel Chilton", location: "Barkley Studio", capacity: 25, registered: 20, waitlist: 0 },
  { id: "cl2", time: "09:00", type: "Heated Hatha", coach: "Lisa R.", location: "Barkley Studio", capacity: 25, registered: 18, waitlist: 0 },
  { id: "cl3", time: "10:30", type: "Slow Flow", coach: "Sarah P.", location: "Barkley Studio", capacity: 25, registered: 16, waitlist: 0 },
  { id: "cl4", time: "12:00", type: "Yin", coach: "Sarah P.", location: "Barkley Studio", capacity: 25, registered: 14, waitlist: 0 },
  { id: "cl5", time: "17:00", type: "Hot Vinyasa", coach: "Jen M.", location: "Barkley Studio", capacity: 25, registered: 24, waitlist: 3 },
  { id: "cl6", time: "18:30", type: "Sculpt", coach: "Kristel Chilton", location: "Barkley Studio", capacity: 25, registered: 20, waitlist: 0 },
];

const WEEKLY_SCHEDULE = [
  { day: "Monday", classes: [{ time: "07:00", type: "Hot Vinyasa", coach: "Kristel" }, { time: "09:00", type: "Heated Hatha", coach: "Lisa" }, { time: "10:30", type: "Slow Flow", coach: "Sarah" }, { time: "12:00", type: "Yin", coach: "Sarah" }, { time: "17:00", type: "Hot Vinyasa", coach: "Jen" }, { time: "18:30", type: "Sculpt", coach: "Kristel" }] },
  { day: "Tuesday", classes: [{ time: "07:00", type: "Hot Vinyasa", coach: "Kristel" }, { time: "09:00", type: "Heated Hatha", coach: "Lisa" }, { time: "10:30", type: "Slow Flow", coach: "Sarah" }, { time: "12:00", type: "Yin", coach: "Sarah" }, { time: "17:00", type: "Hot Vinyasa", coach: "Jen" }, { time: "18:30", type: "Sculpt", coach: "Kristel" }] },
  { day: "Wednesday", classes: [{ time: "07:00", type: "Hot Vinyasa", coach: "Kristel" }, { time: "09:00", type: "Heated Hatha", coach: "Lisa" }, { time: "10:30", type: "Slow Flow", coach: "Sarah" }, { time: "12:00", type: "Yin", coach: "Sarah" }, { time: "17:00", type: "Hot Vinyasa", coach: "Jen" }, { time: "18:30", type: "Sculpt", coach: "Kristel" }] },
  { day: "Thursday", classes: [{ time: "07:00", type: "Hot Vinyasa", coach: "Kristel" }, { time: "09:00", type: "Heated Hatha", coach: "Lisa" }, { time: "10:30", type: "Slow Flow", coach: "Sarah" }, { time: "12:00", type: "Yin", coach: "Sarah" }, { time: "17:00", type: "Hot Vinyasa", coach: "Jen" }, { time: "18:30", type: "Sculpt", coach: "Kristel" }] },
  { day: "Friday", classes: [{ time: "07:00", type: "Hot Vinyasa", coach: "Kristel" }, { time: "09:00", type: "Heated Hatha", coach: "Lisa" }, { time: "10:30", type: "Slow Flow", coach: "Sarah" }, { time: "12:00", type: "Yin", coach: "Sarah" }, { time: "17:00", type: "Hot Vinyasa", coach: "Jen" }, { time: "18:30", type: "Sculpt", coach: "Kristel" }] },
  { day: "Saturday", classes: [{ time: "07:00", type: "Hot Vinyasa", coach: "Kristel" }, { time: "09:00", type: "Heated Hatha", coach: "Lisa" }, { time: "10:30", type: "Qigong", coach: "David" }, { time: "12:00", type: "Yin", coach: "Sarah" }] },
  { day: "Sunday", classes: [{ time: "07:00", type: "Hot Vinyasa", coach: "Kristel" }, { time: "09:00", type: "Heated Hatha", coach: "Lisa" }, { time: "10:30", type: "Qigong", coach: "David" }, { time: "12:00", type: "Yin", coach: "Sarah" }] },
];

const COMMUNITY_FEED = [
  { id: "cf1", user: "Megan T.", milestone: "100 Classes", message: "One hundred classes at Barkley. Kristel and the team made me believe yoga is for everybody, including this body. The infrared heat changed everything.", date: today, celebrations: 28 },
  { id: "cf2", user: "Aaron K.", milestone: "First Heated Hatha", message: "Ninety minutes of 84 postures in infrared heat. Ancient tradition meets modern technology. Lisa guided me through every one. I am hooked.", date: today, celebrations: 22 },
  { id: "cf3", user: "Yuki S.", milestone: "Qigong Regular", message: "David seasonal qigong is unlike anything I have practiced. Moving meditation with Tao Yin meridian stretches. My energy has completely shifted.", date: offsetDate(-1), celebrations: 18 },
  { id: "cf4", user: "Rachel M.", milestone: "30-Day Streak", message: "Thirty days of showing up. Hot vinyasa mornings, yin with the garage doors open in the evenings. Bellingham air and infrared heat. Perfect balance.", date: offsetDate(-2), celebrations: 26 },
];
...
const MILESTONE_BADGES = {
  ...
  "First Heated": { icon: Zap, color: "#8b5cf6" },
  "Qigong Practice": { icon: Waves, color: "#3b82f6" },
  "1 Year Member": { icon: Award, color: T.success },
};

const EVENTS = [
  { id: "ev1", name: "84-Posture Hatha Deep Dive", date: "2026-05-17", startTime: "13:00", type: "Workshop", description: "A 3-hour exploration of the Patanjali 84 postures with Lisa. Alignment, history, and the healing science behind each static hold. For students who want to understand the tradition.", fee: 55, maxParticipants: 25, registered: 16, status: "Registration Open" },
  { id: "ev2", name: "Seasonal Qigong: Summer Form", date: "2026-06-07", startTime: "10:00", type: "Workshop", description: "David introduces the summer seasonal qigong form. Two hours of moving meditation, meridian work, and Daoist longevity practice. No experience necessary.", fee: 40, maxParticipants: 20, registered: 10, status: "Registration Open" },
  { id: "ev3", name: "Ayurveda + Yoga Workshop", date: "2026-06-14", startTime: "14:00", type: "Workshop", description: "Jen weaves Ayurvedic wisdom into practice. Discover your dosha, learn seasonal nutrition, and experience how yoga sister science enhances every class.", fee: 45, maxParticipants: 20, registered: 8, status: "Registration Open" },
];

const MEMBERSHIP_TIERS = [
  { id: "m0", name: "New Student: 2 Weeks", type: "intro", price: 29, period: "2 weeks", features: ["Unlimited classes for 14 days", "All class types", "Hot and non-heated", "New students only"], popular: false },
  { id: "m1", name: "Drop-In", type: "drop-in", price: 25, period: "per class", features: ["Single class credit", "Any class type", "Mat/towel rental $5 each"], popular: false },
  { id: "m2", name: "5 Class Pass", type: "pack", price: 110, period: "5 classes", features: ["$22 per class", "Any class type", "3-month expiration"], popular: false },
  { id: "m3", name: "Unlimited Monthly", type: "unlimited", price: 99, period: "/month", features: ["Unlimited all classes", "Complimentary mat storage", "10-50% off workshops", "3-month minimum, auto-renewing"], popular: true },
  { id: "m4", name: "Annual Unlimited", type: "unlimited", price: 1050, period: "/year", annualEquiv: 88, features: ["Unlimited everything", "Best rate ($88/mo)", "Complimentary mat storage", "10-50% off workshops"], popular: false },
];

const ANNOUNCEMENTS = [
  { id: "a1", title: "New Students: 2 Weeks for $29", message: "Unlimited classes. Hot vinyasa, heated hatha, yin, slow flow, sculpt, qigong. Every body welcome.", type: "celebration", pinned: true },
  { id: "a2", title: "Seasonal Qigong: Summer Form", message: "David introduces the summer seasonal form. Moving meditation and Daoist longevity. June 7.", type: "info", pinned: false },
];

const MEMBERS_DATA = [
  { id: "mem1", name: "Megan Torres", email: "megan@email.com", membership: "Unlimited Monthly", status: "active", joined: "2023-06-01", checkIns: 268, lastVisit: today },
  { id: "mem2", name: "Aaron Kim", email: "aaron@email.com", membership: "5 Class Pass", status: "active", joined: "2026-02-01", checkIns: 4, lastVisit: offsetDate(-2) },
  { id: "mem3", name: "Yuki Sato", email: "yuki@email.com", membership: "Unlimited Monthly", status: "active", joined: "2024-09-01", checkIns: 142, lastVisit: today },
  { id: "mem4", name: "Rachel Moore", email: "rachel@email.com", membership: "Annual Unlimited", status: "active", joined: "2025-01-15", checkIns: 186, lastVisit: offsetDate(-1) },
  { id: "mem5", name: "Jake Chen", email: "jake@email.com", membership: "Unlimited Monthly", status: "frozen", joined: "2024-04-01", checkIns: 78, lastVisit: offsetDate(-28) },
  { id: "mem6", name: "Noa Park", email: "noa@email.com", membership: "New Student Intro", status: "active", joined: "2026-04-10", checkIns: 3, lastVisit: offsetDate(-1) },
];

const ADMIN_METRICS = { activeMembers: 168, memberChange: 9, todayCheckIns: 52, weekCheckIns: 312, monthlyRevenue: 16800, revenueChange: 10.2, renewalRate: 88.6, workshopRevenue: 2400 };

const ADMIN_CHARTS = {
  attendance: [
    { day: "Mon", total: 50, avg: 8 }, { day: "Tue", total: 46, avg: 8 },
    { day: "Wed", total: 48, avg: 8 }, { day: "Thu", total: 44, avg: 7 },
    { day: "Fri", total: 40, avg: 7 }, { day: "Sat", total: 46, avg: 12 },
    { day: "Sun", total: 38, avg: 10 },
  ],
  revenue: [
    { month: "Sep", revenue: 12800 }, { month: "Oct", revenue: 13600 },
    { month: "Nov", revenue: 14200 }, { month: "Dec", revenue: 13000 },
    { month: "Jan", revenue: 15400 }, { month: "Feb", revenue: 16000 },
    { month: "Mar", revenue: 16800 },
  ],
  classPopularity: [
    { name: "7:00 AM", pct: 82 }, { name: "9:00 AM", pct: 74 },
    { name: "10:30 AM", pct: 66 }, { name: "12:00 PM", pct: 58 },
    { name: "5:00 PM", pct: 96 }, { name: "6:30 PM", pct: 82 },
  ],
  membershipBreakdown: [
    { name: "Unlimited Monthly", value: 72, color: T.accent },
    { name: "Annual Unlimited", value: 28, color: T.success },
    { name: "5 Class Pass", value: 30, color: T.warning },
    { name: "Drop-In / Intro", value: 38, color: T.textMuted },
  ],
};
...
function TeacherAvatar({ teacher, size = 56 }) {
  ...
  return (
    <div style={{ width: size, height: size, borderRadius: size > 48 ? 14 : 10, background: `linear-gradient(135deg, ${T.accent}, ${T.accentDark})`, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Calistoga', serif", fontSize: size * 0.38, color: "#fff", flexShrink: 0, fontWeight: 600 }}>
...
function SectionHeader({ title, linkText, linkPage }) {
  ...
  return (
    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12, padding: "0 16px" }}>
      <h2 style={{ fontFamily: "'Calistoga', serif", fontSize: 24, margin: 0, fontWeight: 600 }}>{title}</h2>
    ...
    <div onClick={onToggle} style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderLeft: `4px solid ${typeColors[practice.type] || T.accent}`, borderRadius: 12, padding: isFeatured ? "18px 18px" : "14px 16px", cursor: onToggle ? "pointer" : "default" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: isExpanded ? 10 : 0 }}>
        <div>
          ...
          <h3 style={{ fontFamily: "'Calistoga', serif", fontSize: isFeatured ? 26 : 20, margin: 0, color: T.text, fontWeight: 600 }}>{practice.name}</h3>
        </div>
...
function StatBox({ label, value }) {
  return (
    <div style={{ background: T.bgDim, borderRadius: 8, padding: "10px 12px", textAlign: "center" }}>
      ...
      <p style={{ fontFamily: "'Calistoga', serif", fontSize: 22, color: T.text, margin: 0, fontWeight: 700 }}>{value}</p>
    </div>
  );
}
...
function AdminCard({ title, children }) {
  return (
    <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
      <h3 style={{ fontFamily: "'Calistoga', serif", fontSize: 18, color: "#111827", margin: "0 0 14px", fontWeight: 600 }}>{title}</h3>
      {children}
    </div>
  );
}
    ...
    <div>
            ...
            return (
              <div key={c.id} style={{ display: "flex", alignItems: "center", gap: 12, padding: "14px 16px", background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 12 }}>
                <div style={{ textAlign: "center", minWidth: 48 }}>
                  <span style={{ fontFamily: "'Calistoga', serif", fontSize: 22, color: T.text, fontWeight: 600 }}>{fmtTime(c.time).split(":")[0]}</span>
      ...
      {ANNOUNCEMENTS.length > 0 && (
        <section style={{ marginTop: 28, padding: "0 16px" }}>
          <h2 style={{ fontFamily: "'Calistoga', serif", fontSize: 24, margin: "0 0 12px", fontWeight: 600 }}>Announcements</h2>
      ...
      <section style={{ padding: "16px 16px 8px", marginTop: 20 }}>
        <div style={{ background: `linear-gradient(165deg, ${T.bg}, hsl(30,20%,14%))`, borderRadius: 16, padding: "24px 20px", color: "#fff", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative" }}>
            <h3 style={{ fontFamily: "'Calistoga', serif", fontSize: 24, margin: "0 0 6px", fontWeight: 600 }}>New to Barkley?</h3>
            <p style={{ fontSize: 13, color: "#b8a898", margin: "0 0 16px", lineHeight: 1.5 }}>New students: 2 weeks unlimited for $29. All class types.</p>
            <button onClick={() => {}} style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "10px 20px", borderRadius: 8, border: "none", background: T.accent, color: "#fff", fontFamily: "'Calistoga', serif", fontSize: 15, cursor: "pointer", fontWeight: 600 }}>View Memberships <ChevronRight size={16} /></button>
          </div>
        </div>
      </section>
    </div>
      ...
      <div style={{ padding: "20px 16px 0" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          {WEEKLY_SCHEDULE[selectedDay]?.classes.map((cls, i) => {
            const isSpecial = cls.type.includes("Yin") || cls.type.includes("Qigong") || cls.type.includes("Slow") || cls.type.includes("Pilates");
            return (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, padding: "14px 16px", background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 12 }}>
                <div style={{ textAlign: "center", minWidth: 54 }}>
                  <span style={{ fontFamily: "'Calistoga', serif", fontSize: 16, color: T.text, fontWeight: 600 }}>{fmtTime(cls.time)}</span>
                </div>
                <div style={{ flex: 1 }}>
                ...
                <button onClick={() => openReservation({ id: `sched-${selectedDay}-${i}`, time: cls.time, type: cls.type, coach: cls.coach || "TBD", location: cls.location || "Barkley Studio", capacity: isSpecial ? STUDIO_CONFIG.specialtyCapacity : STUDIO_CONFIG.classCapacity, registered: Math.floor(Math.random() * 10) + 15, waitlist: 0, dayLabel: dayNames[selectedDay] })} style={{ padding: "8px 14px", borderRadius: 8, border: "none", fontSize: 12, fontWeight: 600, cursor: "pointer", background: T.accent, color: "#fff" }}>Reserve</button>
              </div>
            );
          })}
        </div>
    ...
    <div>
      ...
      <div style={{ padding: "20px 16px 0" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginBottom: 20 }}>
          {[
            ...
            <div key={i} style={{ background: s.ghost, border: `1px solid ${s.bdr}`, borderRadius: 12, padding: "14px 10px", textAlign: "center" }}>
              ...
              <div style={{ fontFamily: "'Calistoga', serif", fontSize: 28, fontWeight: 700, color: T.text }}>{s.val}</div>
        ...
        {activeTab === "log" && (
          <div style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 12, padding: 20 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <button onClick={() => { setSaved(true); setTimeout(() => setSaved(null), 2000); setReflection({ energy: 4, focus: 4, notes: "" }); }} style={{ padding: "12px 0", borderRadius: 8, border: "none", fontWeight: 700, cursor: "pointer", background: T.accent, color: "#fff", fontFamily: "'Calistoga', serif", fontSize: 17 }}>
        ...
        <div style={{ marginTop: 24 }}>
          <h3 style={{ fontFamily: "'Calistoga', serif", fontSize: 22, margin: "0 0 12px", fontWeight: 600 }}>Recent Practice</h3>
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {[
              { date: today, name: "Hot Vinyasa", result: "60 min", badge: "hot", icon: Sun, color: T.warning, ghost: T.warningGhost },
              { date: offsetDate(-1), name: "Yin (Non-Heated)", result: "60 min", badge: "yin", icon: Moon, color: "#8b5cf6", ghost: "#8b5cf610" },
              { date: offsetDate(-2), name: "Heated Hatha", result: "90 min", badge: "hatha", icon: Flame, color: T.accent, ghost: T.accentGhost },
            ].map((h, i) => (
      ...
      <div style={{ padding: "20px 16px 0" }}>
        {STUDIO_CONFIG.features.guestPasses && (
          <div style={{ background: `linear-gradient(135deg, ${T.bg}, hsl(30,20%,14%))`, borderRadius: 14, padding: "18px", marginBottom: 20, color: "#fff" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}><Gift size={20} color={T.accent} /><h3 style={{ fontFamily: "'Calistoga', serif", fontSize: 18, margin: 0, fontWeight: 600 }}>Guest Passes</h3></div>
            ...
            return (
              <div key={item.id} style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 14, padding: "16px 18px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                  <div style={{ width: 40, height: 40, borderRadius: "50%", background: `linear-gradient(135deg, ${T.accent}, ${T.accentDark})`, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Calistoga', serif", fontSize: 16, color: "#fff", fontWeight: 700, flexShrink: 0 }}>{item.user[0]}</div>
      ...
      <div style={{ padding: "20px 16px 0", display: "flex", flexDirection: "column", gap: 12 }}>
        {MEMBERSHIP_TIERS.map(tier => (
          <div key={tier.id} style={{ background: T.bgCard, border: `1px solid ${tier.popular ? T.accent : T.border}`, borderRadius: 14, padding: "20px 18px", position: "relative", overflow: "hidden" }}>
            ...
            <h3 style={{ fontFamily: "'Calistoga', serif", fontSize: 22, margin: "0 0 4px", color: T.text, fontWeight: 600 }}>{tier.name}</h3>
            <div style={{ display: "flex", alignItems: "baseline", gap: 4, marginBottom: 12 }}>
              <span style={{ fontFamily: "'Calistoga', serif", fontSize: 38, color: T.accent, fontWeight: 700 }}>${tier.price}</span>
            ...
            <button style={{ width: "100%", padding: "12px 0", borderRadius: 8, border: "none", fontSize: 16, fontWeight: 700, cursor: "pointer", fontFamily: "'Calistoga', serif", background: tier.popular ? T.accent : T.bg, color: "#fff" }}>Get Started</button>
          </div>
        ))}
      </div>
    </div>
        ...
        {EVENTS.map(ev => (
          <div key={ev.id} style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 14, overflow: "hidden", marginBottom: 16 }}>
            <div style={{ background: `linear-gradient(135deg, ${T.bg}, hsl(30,20%,14%))`, padding: "20px 18px", color: "#fff" }}>
              ...
              <h3 style={{ fontFamily: "'Calistoga', serif", fontSize: 20, margin: "6px 0 4px", fontWeight: 600 }}>{ev.name}</h3>
            ...
            <div style={{ padding: "16px 18px" }}>
              ...
              <button style={{ width: "100%", padding: "12px 0", borderRadius: 8, border: "none", fontSize: 16, fontWeight: 700, cursor: "pointer", fontFamily: "'Calistoga', serif", background: T.accent, color: "#fff" }}>Register Now</button>
            </div>
          </div>
        ))}
      </div>
...
function AdminDashboard() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div><h1 style={{ fontFamily: "'Calistoga', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Dashboard</h1><p style={{ fontSize: 13, color: "#6b7280", margin: "4px 0 0" }}>Welcome back. Here is what is happening at Barkley Yoga.</p></div>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 14 }}>
        {metrics.map((m, i) => (
          <div key={i} style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
            ...
            <div style={{ fontFamily: "'Calistoga', serif", fontSize: 30, color: "#111827", fontWeight: 700 }}>{m.value}</div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 14 }}>
        ...
        <AdminCard title="Recent Activity">
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            {[{ text: "New member signup", detail: "Noa Park - New Student Intro", time: "5 min ago", color: T.accent },{ text: "Workshop registration", detail: "Qigong Workshop - Yuki S.", time: "12 min ago", color: "#8b5cf6" },{ text: "Class waitlist full", detail: "5:00 PM Hot Vinyasa", time: "18 min ago", color: T.success },{ text: "Payment received", detail: "Unlimited Monthly - Megan Torres", time: "25 min ago", color: T.warning },{ text: "Guest pass redeemed", detail: "Megan Torres's guest", time: "1 hr ago", color: "#3b82f6" }].map((a, i) => (
...
function AdminMembersPage() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Calistoga', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Members</h1><CrudBar addLabel="Add Member" /></div>
      <div style={{ display: "flex", gap: 10 }}>
        ...
        <div style={{ display: "flex", gap: 4 }}>{["all", "active", "frozen"].map(f => <button key={f} onClick={() => setFilter(f)} style={{ padding: "8px 14px", borderRadius: 8, border: "none", fontSize: 12, fontWeight: 600, cursor: "pointer", textTransform: "capitalize", background: filter === f ? T.accent : "#f3f4f6", color: filter === f ? "#fff" : "#9ca3af" }}>{f}</button>)}</div>
      </div>
...
function AdminSchedulePage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Calistoga', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Schedule</h1><CrudBar addLabel="Add Class" /></div>
      <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, overflow: "hidden" }}>
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
...
function AdminTeachersPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Calistoga', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Teachers</h1><CrudBar addLabel="Add Teacher" /></div>
...
function AdminEventsPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Calistoga', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Events & Workshops</h1><CrudBar addLabel="New Event" /></div>
      {EVENTS.map(ev => (
        <div key={ev.id} style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 8 }}>
              <div style={{ textAlign: "right" }}><div style={{ fontFamily: "'Calistoga', serif", fontSize: 28, color: T.accent, fontWeight: 700 }}>{ev.registered}</div><p style={{ fontSize: 11, color: "#9ca3af" }}>of {ev.maxParticipants}</p></div>
              <CrudActions />
            </div>
          </div>
        </div>
...
function AdminPricingPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Calistoga', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Pricing & Memberships</h1><CrudBar addLabel="Add Tier" /></div>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 14 }}>
        {MEMBERSHIP_TIERS.map(tier => (
          <div key={tier.id} style={{ background: "#fff", border: `1px solid ${tier.popular ? T.accent : "#e5e7eb"}`, borderRadius: 12, padding: 18 }}>
            ...
            <h3 style={{ fontFamily: "'Calistoga', serif", fontSize: 20, color: "#111827", margin: "0 0 4px", fontWeight: 600 }}>{tier.name}</h3>
            <div style={{ fontFamily: "'Calistoga', serif", fontSize: 32, color: T.accent, fontWeight: 700 }}>${tier.price}<span style={{ fontSize: 14, color: "#9ca3af", fontWeight: 400 }}> {tier.period}</span></div>
...
function AdminBroadcastPage() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <h1 style={{ fontFamily: "'Calistoga', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Broadcast</h1>
      <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
...
function AdminSettingsPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <h1 style={{ fontFamily: "'Calistoga', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Studio Settings</h1>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          {["MindBody API", "Stripe Payments", "Mailchimp", "Google Calendar"].map((name, i) => (
            <div key={i} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 12px", background: "#f9fafb", borderRadius: 8 }}>
              <span style={{ fontSize: 13, color: "#111827", fontWeight: 600 }}>{name}</span>
        ...
        {!confirmed ? (
          <>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
              <h2 style={{ fontFamily: "'Calistoga', serif", fontSize: 24, margin: 0, color: T.text, fontWeight: 600 }}>Confirm Reservation</h2>
            ...
            <div style={{ background: T.bgDim, borderRadius: 14, padding: "18px 16px", marginBottom: 20 }}>
              ...
              <div style={{ marginTop: 16, display: "flex", flexDirection: "column", gap: 10 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}><MapPin size={16} color={T.textMuted} /><span style={{ fontSize: 14, color: T.text }}>3130 Howe Pl, Unit 102, Bellingham</span></div>
              </div>
            </div>
            <div style={{ background: T.accentGhost, border: `1px solid ${T.accentBorder}`, borderRadius: 10, padding: "12px 14px", marginBottom: 20 }}>
              ...
              <p style={{ fontSize: 12, color: "#5a5040", margin: "0 0 4px", lineHeight: 1.4 }}>Manduka mat and Yogitoes towel rental $5 each. Max 25 students.. Email info@barkleyyoga.com to avoid fees.</p>
              <p style={{ fontSize: 12, color: "#5a5040", margin: 0, lineHeight: 1.4 }}>Infrared heated. HVAC + air purifier. Garage doors open for non-heated..</p>
            </div>
            <button onClick={() => { setConfirmed(true); onConfirm(classData.id); }} style={{ width: "100%", padding: "14px 0", borderRadius: 10, border: "none", fontSize: 17, fontWeight: 700, cursor: "pointer", fontFamily: "'Calistoga', serif", background: isFull ? T.success : T.accent, color: "#fff", marginBottom: 8 }}>{isFull ? "Join Waitlist" : "Confirm Reservation"}</button>
          ...
          <div style={{ textAlign: "center", padding: "10px 0" }}>
            ...
            <h2 style={{ fontFamily: "'Calistoga', serif", fontSize: 24, margin: "0 0 4px", color: T.text, fontWeight: 600 }}>{isFull ? "Added to Waitlist" : "You're In!"}</h2>
            ...
            <button onClick={onClose} style={{ width: "100%", padding: "14px 0", borderRadius: 10, border: "none", fontSize: 17, fontWeight: 700, cursor: "pointer", fontFamily: "'Calistoga', serif", background: T.accent, color: "#fff" }}>Done</button>
          </div>
        )}
      </div>
      ...
      <div onClick={e => e.stopPropagation()} style={{ background: T.bgCard, borderRadius: "20px 20px 0 0", width: "100%", maxWidth: 390, maxHeight: "85vh", overflow: "auto", padding: "20px 20px 40px" }}>
        ...
        <div style={{ padding: "14px 0", borderBottom: `1px solid ${T.borderLight}` }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div style={{ width: 48, height: 48, borderRadius: 12, background: `linear-gradient(135deg, ${T.accent}, ${T.accentDark})`, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Calistoga', serif", fontSize: 20, color: "#fff", fontWeight: 700 }}>MT</div>
            <div><p style={{ fontWeight: 700, margin: 0, fontSize: 15 }}>Megan Torres</p><p style={{ fontSize: 12, color: T.textMuted, margin: "2px 0 0" }}>Unlimited Monthly — Since Jun 2023</p></div>
          </div>
        </div>
        <div style={{ padding: "14px 0", borderBottom: `1px solid ${T.borderLight}` }}>
...
function NotificationsModal({ onClose }) {
  const notifications = [
    { id: 1, title: "Tomorrow: Sculpt", message: "Weights + power yoga. Full-body workout. Heated.", type: "class", time: "2 hours ago", read: false },
    { id: 2, title: "New Milestone!", message: "Rachel M. hit 30-day streak. Celebrate together!", type: "community", time: "4 hours ago", read: false },
    { id: 3, title: "Class Reminder", message: "Reserved for 5:00 PM Hot Vinyasa with Nicole.", type: "class", time: "6 hours ago", read: true },
    { id: 4, title: "Seasonal Qigong: Summer Form", message: "Moving meditation with David. June 7. Register now.", type: "event", time: "1 day ago", read: true },
  ];
  return (
    <div onClick={onClose} style={{ position: "absolute", inset: 0, background: "rgba(0,0,0,.5)", backdropFilter: "blur(4px)", zIndex: 100, display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
...
export default function App({ startInAdmin, onExitAdmin, onEnterAdmin }) {
  ...
  if (isAdmin) {
    ...
    return (
      <AppContext.Provider value={{ page, setPage, classRegistrations, registerForClass, openReservation, feedCelebrations, celebrateFeed }}>
        <div style={{ display: "flex", width: "100vw", height: "100vh", fontFamily: "'Nunito Sans', system-ui, sans-serif", background: "#f8f9fa" }}>
          <aside style={{ width: 240, background: "#fff", borderRight: "1px solid #e5e7eb", color: "#1a1a1a", display: "flex", flexDirection: "column", flexShrink: 0 }}>
            <div style={{ padding: "16px 14px", borderBottom: "1px solid #e5e7eb" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <div style={{ width: 32, height: 32, borderRadius: 8, background: T.accent, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Calistoga', serif", fontSize: 14, color: "#fff", fontWeight: 700 }}>{STUDIO_CONFIG.logoMark}</div>
                <div><span style={{ fontFamily: "'Calistoga', serif", fontSize: 16, display: "block", lineHeight: 1, fontWeight: 600, color: "#111827" }}>BY</span><span style={{ fontSize: 8, color: "#9ca3af", textTransform: "uppercase", letterSpacing: "0.15em" }}>Admin</span></div>
              </div>
            </div>
          ...
          <main style={{ flex: 1, padding: 24, overflow: "auto", background: "#f8f9fa" }}>{renderAdminPage()}</main>
        </div>
      </AppContext.Provider>
    );
  }
  ...
  return (
    <AppContext.Provider value={{ page, setPage, classRegistrations, registerForClass, openReservation, feedCelebrations, celebrateFeed }}>
      <div style={{ width: "100%", height: "100%", background: T.bgDim, fontFamily: "'Nunito Sans', system-ui, sans-serif", position: "relative", overflow: "hidden" }}>
        <header style={{ position: "relative", zIndex: 30, background: T.bg, color: "#fff", padding: "10px 14px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <div style={{ width: 34, height: 34, borderRadius: 8, background: T.accent, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Calistoga', serif", fontSize: 14, color: "#fff", fontWeight: 700 }}>{STUDIO_CONFIG.logoMark}</div>
            <div style={{ display: "flex", flexDirection: "column" }}>
              <span style={{ fontFamily: "'Calistoga', serif", fontSize: 18, lineHeight: 1, fontWeight: 600 }}>{STUDIO_CONFIG.name}</span>
        ...
        {showMore && (
          <div onClick={() => setShowMore(false)} style={{ position: "absolute", inset: 0, background: "rgba(0,0,0,.5)", backdropFilter: "blur(4px)", zIndex: 40 }}>
            <div onClick={e => e.stopPropagation()} style={{ position: "absolute", bottom: 68, left: 16, right: 16, background: T.bgCard, borderRadius: 16, padding: "14px 12px", boxShadow: "0 8px 32px rgba(0,0,0,.15)" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "0 6px 8px" }}><span style={{ fontFamily: "'Calistoga', serif", fontSize: 20, fontWeight: 600 }}>More</span><button onClick={() => setShowMore(false)} style={{ padding: 4, borderRadius: 6, border: "none", background: "transparent", cursor: "pointer" }}><X size={18} color={T.textMuted} /></button></div>
